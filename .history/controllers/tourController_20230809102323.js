...
exports.resizeTourImages = async (req, res, next) => {
  ...
  //1) Cover Image
  const imageCoverFilename =`tour-${req.params.id}-${Data.now()}-cover.jpeg`
    await sharp(req.files.imageCover[0].buffer)
    .resize(2000, 1333)
    .toFormat('jpeg')
    .jpeg({ quality: 90 })
    .toFile(`public/img/tours/${imageCoveFilenamer}`);
}
...
// /tours-within/:distance/center/:latlng/unit/:uint
// /tours-within/233/center/34.035980, -118.247777/unit/mi
