...
exports.forgotPassword = catchAsync(async (req, res, next) => {
  ...
  const resetURL = `${req.protocol}://${req.get(
   ...
   message = `Forgot your password? Submit a PATCH request with your new password 
  and passwordConfirm to:${resetURL}.\nIf you didn't forget yourconst password,please ignore this email!`;
  try {
...
exports.isLoggedIn = async (req, res, next) => {
  try {
    if (req.cookies.jwt) {
      ...
      res.locals.user = currentUser; //can get access to the user in the pug template
      return next();
    }
  } catch (err) {
    return next();
